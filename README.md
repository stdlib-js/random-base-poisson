...
```javascript
poisson = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-poisson@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-base-poisson/tags). For example,

```javascript
poisson = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-poisson@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var poisson = require( 'path/to/vendor/umd/random-base-poisson/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-base-poisson/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-base-poisson/actions/workflows/test.yml?query=branch:v0.1.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-base-poisson.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-base-poisson/main
